...
def back():
    ...
    print logo
    try:
        key1 = open('/sdcard/toufiq.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print '____\033[1;32m First Get Approvel Frist____'
        print '____This Tools Are Paid So You Need Permission Frist____'
        print '____Key is Not Approved____'
        print '____And Send Key To Admin____'
        print ''
        myid = uuid.uuid4().hex[:10]
        print '         YOUR KEY : ' + myid + imt
        kok = open('/sdcard/risat.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
        print '____\033[1;32m First Get Approvel Frist____'
    ...
    r1 = requests.get('https://pastebin.com/65di5FTs').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        print logo
        print '____\033[1;32m First Get Approvel Frist____'
        print '____This Tools Are Paid So You Need Permission Frist__'
        print '____Key is Not Approved____'
        print '____And Send Key To Admin____'
        print ''
        print '____YOUR KEY : ' + key1
        print ''
        print '____Copy To Send WhatsApp____'
        print ''
        print ''
        print ''
        os.system('xdg-open https://wa.me/+8801812027446')
